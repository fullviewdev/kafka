...
public class FVSessionWindowedKStreamImpl<K, V extends FVSessionEvent> extends AbstractStream<K, V> implements SessionWindowedKStream<K, V> {
    ...
    FVSessionWindowedKStreamImpl(final FVSessionWindows windows,
    ...
    private KTable<Windowed<K>, Long> doCount(final Named named,
        ...
        return aggregateBuilder.build(
            ...
            new KStreamFVSessionWindowAggregate<>(
                windows,
